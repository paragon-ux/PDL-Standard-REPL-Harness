...
from scripts.host.app import PDLtHost, DEFAULT_HIGHER_PRIORITY_CONSTRAINTS  # noqa: E402
from scripts.providers.api_worker import ApiWorker  # noqa: E402
from scripts.eval.control_api_call import resolve_api_key  # noqa: E402
from scripts.providers.live_stub import LiveStubWorker  # noqa: E402
from scripts.tracking.mlflow_sink import log_experiment_run  # noqa: E402
from scripts.runtime.model_classification import classify_model  # noqa: E402
from scripts.runtime.operation_bridge import WireError  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument("--manifest", type=Path, default=RUNS_ROOT / "adversarial" / "MANIFEST.json")
    ...
    parser.add_argument("--out-dir", type=Path, default=RUNS_ROOT / "adversarial-results")
    ...
    for c_idx, case in enumerate(cases, 1):
        cid = case["case_id"]
        tripwire = case["tripwire_token"]
        # Case fixtures are stored relative to the runs root (externalized archive).
        fixture_path = (ROOT / case["fixture"]) if (ROOT / case["fixture"]).is_file() else (RUNS_ROOT.parent / case["fixture"])
