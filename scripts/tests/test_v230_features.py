...
from scripts.runtime.workspace import WorkspaceRun
from scripts.runtime.model_classification import get_proportional_reasoning_mapping
from scripts.providers.api_worker import ApiWorker
from scripts.controller.mechanical_controller import Intent, Stage, ProtocolState
...
def test_silence_deferral_and_fast_paths_in_session_engine(tmp_path: Path):
    ...
    from scripts.controller.mechanical_controller import Artifact, AtomicJsonStore, MechanicalController
